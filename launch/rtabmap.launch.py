...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frame_id',       default_value='uav/base_link',          description='Fixed frame id of the robot (base frame), you may set "base_link" or "base_footprint" if they are published. For camera-only config, this could be "camera_link".'),
        DeclareLaunchArgument('odom_frame_id',  default_value='uav/odom',                   description='If set, TF is used to get odometry instead of the topic.'),
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/uav/camera/image_raw',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/uav/camera/depth/image_raw', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/uav/camera/camera_info',            description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/model/x500_depth_0/odometry',  description='Odometry topic name.'),
